...
#    Updated: 2022/07/04 20:37:49 by hoomen           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC		= main.c parse.c init.c fractals.c newtons_utils.c color.c hsv2rgb.c events.c zoom.c event_handlers.c event_handlers2.c
